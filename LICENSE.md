...
**Manyteller** and all associated materials (prompts, character card architecture, cognitive system definitions, presets, lorebooks, documentation, and code in this repository) are licensed under:
...
You are free to:
- **View and read** everything in this repository.
- **Use it personally** — run it, adapt it privately for your own non-commercial roleplay/storytelling use.
- **Share it** — link to or redistribute this repository as-is, with credit, for non-commercial purposes.

You may **not**, without separate written permission from the author:
- Use this work, in whole or in part, for **any commercial purpose** (selling access, bundling into a paid product, offering it as a paid service, monetized Patreon/Discord tiers built on it, etc.)
- **Publish or redistribute modified versions** of this work (forks, derivative frameworks, "based on Framework_2" adaptations) publicly.
